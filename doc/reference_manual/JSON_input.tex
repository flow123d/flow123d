...
Output from the models is controlled by an interplay of following records: \hyperA{OutputStream}{{\tt OutputStream}},
\hyperA{Balance}{{\tt Balance}}, and \hyperA{EquationOutput}{{\tt EquationOutput}}. The first two are part of the 
...
\ref{sec:TimeGrid}
An array of the \hyperA{TimeGrid}{{\tt TimeGrid}} records may be used to setup a sequence of times. Such sequence is used in particular 
