...
\begin{verbatim}
  ...
  > ./install.sh
\end{verbatim}
\tbd{what should be the result?}


\subsection{Installing Flow123d on Windows}
On the Windows systems we require Powershell. \tbd{Is it standard part of which Windows or how it can be obtained.} 
Make sure \verb'powershell' command is in the system path. \tbd{How} To install Flow123d on Windows,
first download the Windows installation package archive \verb'Flow123d-2.1.0-windows.zip' and extract it to any folder.
