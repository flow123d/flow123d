...
\begin{Verbatim}[numbers=left, firstnumber=last]
    primary_equation = {
      ...
      bulk_data = [
        { r_set = "1d_domain", cond_anisothropy = 10 },
        { region = "2d",       cond_anisothropy = 1  }
      ],
...
(i.e. the bulk domain) in the case of 
...
inflow part of the boundary. There is also some adsorption and dual porosity model in this particular test case, but we do not discuss this topic here since it dosn't intrinsicaly 
influence the result, se Section \ref{} for the description. On Figure \ref{fig:tutorial} you can see results, the pressure and the velocity field on the left and the concentration at time $t=0.9$ on the right.
