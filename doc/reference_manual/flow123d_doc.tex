...
The directory \verb'Flow123d-2.1.0-windows-install' will be created. You can rename it or move it elsewhere before you start installation, but not later. 
...
\begin{enumerate}
	...
	and further modified to provide better integration with your system. You will be asked twice to allow changes to the \emph{'VirtualBox Interface'}.
	...
	By default we setup such mapping for the home directory \verb'C:/Users/<user>' which is mapped to \verb'/c/Users/<user>'. 
	...
	(recursively). The question is repeated allowing to add more custom mappings one by one. 
\end{enumerate}
