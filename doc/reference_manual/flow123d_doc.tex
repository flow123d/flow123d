...
inflow part of the boundary. There are also some sorption and dual porosity models in this particular test case. Sorption and simple reactions model inputs are particularly described in subsections \ref{subsubsec:reactions}.%, but we do not discuss this topic here for the sake of simplicity.
