...
\begin{RecordType}
	...
	{{{Configuration of the spatial output of a single balance equation.}% 
		...
		\RecKey
			...
			{{Integer [0, INT]}}{}
			{ \ValueDefault{17}}
			{{{The number of decimal digits used in output of floating point values.{\textbackslash} Default is about 17 decimal digits which is enough to keep double values exect after write-read cycle.}% 
}}
		\RecKey
