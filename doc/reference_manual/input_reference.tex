...
These times have to form an increasing sequence.}% 
		...
		\RecKey
			{Mechanics-LinearElasticity-FE-Data::biot-alpha}
			{biot{\_}alpha}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Biot coefficient. }{$[-]$}% 
...
\begin{SelectionType}
	...
	{{{Selection of output fields for the Mechanics{\_}LinearElasticity{\_}FE model.}% 
		...
		\SelectionItem
			...
			{load}
			{{{}{$[m^{-3}kgs^{-2}]$}{ Input field: Prescribed load.}% 
}}
		\SelectionItem
			{Mechanics-LinearElasticity-FE-OutputFields::young-modulus}
			{young{\_}modulus}
			{{{}{$[m^{-1}kgs^{-2}]$}{ Input field: Young modulus.}% 
}}
		\SelectionItem
			{Mechanics-LinearElasticity-FE-OutputFields::poisson-ratio}
			{poisson{\_}ratio}
			{{{}{$[-]$}{ Input field: Poisson ratio.}% 
}}
		\SelectionItem
			{Mechanics-LinearElasticity-FE-OutputFields::biot-alpha}
			{biot{\_}alpha}
			{{{}{$[-]$}{ Input field: Biot coefficient.}% 
}}
		\SelectionItem
