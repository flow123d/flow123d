...
\begin{SelectionType}
	...
	{{{Selection of output fields for the Mechanics{\_}LinearElasticity{\_}FE model.}% 
		...
		\SelectionItem
			{Mechanics-LinearElasticity-FE-OutputFields::effective-stress}
			{effective{\_}stress}
			{{{}{$[m^{-1}kgs^{-2}]$}{ Effective (mechanical) stress tensor output.}% 
}}
		\SelectionItem
			{Mechanics-LinearElasticity-FE-OutputFields::total-stress}
			{total{\_}stress}
			{{{}{$[m^{-1}kgs^{-2}]$}{ Total poroelastic stress output.}% 
}}
		\SelectionItem
		...
		\SelectionItem
			{Mechanics-LinearElasticity-FE-OutputFields::mean-effective-stress}
			{mean{\_}effective{\_}stress}
			{{{}{$[m^{-1}kgs^{-2}]$}{ Mean effective stress output.}% 
}}
		\SelectionItem
			{Mechanics-LinearElasticity-FE-OutputFields::mean-total-stress}
			{mean{\_}total{\_}stress}
			{{{}{$[m^{-1}kgs^{-2}]$}{ Mean total stress output.}% 
}}
		\SelectionItem
