...
\begin{TupleType}
	...
	{{{A time with optional unit specification.}% 
		...
		\RecKey
			...
			{{{The time unit.
Possible values: 's' seconds, 'min' minutes, 'h' hours, 'd' days, 'y' years.}% 
}}
\end{TupleType}
\begin{TupleType}
	{IT::TimeValue-2}
...
\begin{RecordType}
	...
	{FirstOrderReaction}
	{\TypeLink{IT::ReactionTermImmobile}{ReactionTermImmobile}{, }\TypeLink{IT::ReactionTerm}{ReactionTerm}{, }\TypeLink{IT::ReactionTermMobile}{ReactionTermMobile}{, }\TypeLink{IT::GenericReaction}{GenericReaction}}% implements
	{}% reducible to key
