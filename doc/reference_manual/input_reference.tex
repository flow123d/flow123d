...
\KeyItem{\hyperB{Sorptions::solubility}{solubility}}{Array  of Double [0, ]}{\textless\it optional\textgreater}{}{Specifies solubility limits of all the sorbing species}
\KeyItem{\hyperB{Sorptions::table-limits}{table\_limits}}{Array  of Double [0, ]}{\textless\it optional\textgreater}{}{Specifies highest aqueous concentration in interpolation table.}
...
\KeyItem{\hyperB{Sorptions::time}{time}}{Double }{1.0}{}{Key called time required by TimeGovernor in Sorption constructor.}
\end{RecordType}
...
\KeyItem{\hyperB{ConcentrationTransport-DG::output}{output}}{record: \hyperlink{IT::TransportOutput}{TransportOutput}}{\textless\it obligatory\textgreater}{}{Parameters of output stream.}
...
\KeyItem{\hyperB{ConcentrationTransport-DG::bc-data}{bc\_data}}{Array  of record: \hyperlink{IT::TransportDG-BoundaryData}{TransportDG\_BoundaryData}}{\textless\it obligatory\textgreater}{}{}
\KeyItem{\hyperB{ConcentrationTransport-DG::bulk-data}{bulk\_data}}{Array  of record: \hyperlink{IT::TransportDG-BulkData}{TransportDG\_BulkData}}{\textless\it obligatory\textgreater}{}{}
...
\KeyItem{\hyperB{TransportDG-BoundaryData::bc-conc}{bc\_conc}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Default Field value: 0 \\ Dirichlet boundary condition (for each substance).}
...
\KeyItem{\hyperB{TransportDG-BulkData::fracture-sigma}{fracture\_sigma}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Default Field value: 1 \\ Coefficient of diffusive transfer through fractures (for each substance).}
...
\KeyItem{\hyperB{HeatTransfer-DG::output}{output}}{record: \hyperlink{IT::TransportOutput}{TransportOutput}}{\textless\it obligatory\textgreater}{}{Parameters of output stream.}
...
\KeyItem{\hyperB{HeatTransfer-DG::bc-data}{bc\_data}}{Array  of record: \hyperlink{IT::HeatTransfer-BoundaryData}{HeatTransfer\_BoundaryData}}{\textless\it obligatory\textgreater}{}{}
\KeyItem{\hyperB{HeatTransfer-DG::bulk-data}{bulk\_data}}{Array  of record: \hyperlink{IT::HeatTransfer-BulkData}{HeatTransfer\_BulkData}}{\textless\it obligatory\textgreater}{}{}
...
\begin{RecordType}{\HTRaised{IT::HeatTransfer-BoundaryData}{HeatTransfer\_BoundaryData}}{}{}{}{Record to set BOUNDARY fields of the equation 'HeatTransfer'.
The fields are set only on the domain specified by one of the keys: 'region', 'rid', 'r\_set'
and after the time given by the key 'time'. The field setting can be overridden by
 any HeatTransfer\_BoundaryData record that comes later in the boundary data array.}
\KeyItem{\hyperB{HeatTransfer-BoundaryData::r-set}{r\_set}}{String (generic)}{\textless\it optional\textgreater}{}{Name of region set where to set fields.}
\KeyItem{\hyperB{HeatTransfer-BoundaryData::region}{region}}{String (generic)}{\textless\it optional\textgreater}{}{Label of the region where to set fields. }
\KeyItem{\hyperB{HeatTransfer-BoundaryData::rid}{rid}}{Integer [0, ]}{\textless\it optional\textgreater}{}{ID of the region where to set fields.}
\KeyItem{\hyperB{HeatTransfer-BoundaryData::time}{time}}{Double [0, ]}{0.0}{}{Apply field setting in this record after this time.\\These times have to form an increasing sequence.}
\KeyItem{\hyperB{HeatTransfer-BoundaryData::bc-temperature}{bc\_temperature}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Default Field value: 0 \\ Boundary value of temperature.}
\KeyItem{\hyperB{HeatTransfer-BoundaryData::bc-type}{bc\_type}}{abstract type: \hyperlink{IT::Field:R3 - Enum[n]}{Field:R3 $\rightarrow$ Enum[n]}}{\textless\it optional\textgreater}{}{Default Field value: inflow \\ Boundary condition type, possible values: inflow, dirichlet, neumann, robin.}
\KeyItem{\hyperB{HeatTransfer-BoundaryData::bc-flux}{bc\_flux}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Default Field value: 0.0 \\ Flux in Neumann boundary condition.}
\KeyItem{\hyperB{HeatTransfer-BoundaryData::bc-robin-sigma}{bc\_robin\_sigma}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Default Field value: 0.0 \\ Conductivity coefficient in Robin boundary condition.}
\end{RecordType}

\begin{RecordType}{\HTRaised{IT::HeatTransfer-BulkData}{HeatTransfer\_BulkData}}{}{}{}{Record to set BULK fields of the equation 'HeatTransfer'.
The fields are set only on the domain specified by one of the keys: 'region', 'rid', 'r\_set'
and after the time given by the key 'time'. The field setting can be overridden by
 any HeatTransfer\_BulkData record that comes later in the bulk data array.}
\KeyItem{\hyperB{HeatTransfer-BulkData::r-set}{r\_set}}{String (generic)}{\textless\it optional\textgreater}{}{Name of region set where to set fields.}
\KeyItem{\hyperB{HeatTransfer-BulkData::region}{region}}{String (generic)}{\textless\it optional\textgreater}{}{Label of the region where to set fields. }
\KeyItem{\hyperB{HeatTransfer-BulkData::rid}{rid}}{Integer [0, ]}{\textless\it optional\textgreater}{}{ID of the region where to set fields.}
\KeyItem{\hyperB{HeatTransfer-BulkData::time}{time}}{Double [0, ]}{0.0}{}{Apply field setting in this record after this time.\\These times have to form an increasing sequence.}
\KeyItem{\hyperB{HeatTransfer-BulkData::init-temperature}{init\_temperature}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Default Field value: 0 \\ Initial temperature.}
\KeyItem{\hyperB{HeatTransfer-BulkData::porosity}{porosity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Default Field value: 1 \\ Porosity.}
\KeyItem{\hyperB{HeatTransfer-BulkData::fluid-density}{fluid\_density}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Density of fluid.}
\KeyItem{\hyperB{HeatTransfer-BulkData::fluid-heat-capacity}{fluid\_heat\_capacity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Heat capacity of fluid.}
\KeyItem{\hyperB{HeatTransfer-BulkData::fluid-heat-conductivity}{fluid\_heat\_conductivity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Heat conductivity of fluid.}
\KeyItem{\hyperB{HeatTransfer-BulkData::solid-density}{solid\_density}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Density of solid (rock).}
\KeyItem{\hyperB{HeatTransfer-BulkData::solid-heat-capacity}{solid\_heat\_capacity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Heat capacity of solid (rock).}
\KeyItem{\hyperB{HeatTransfer-BulkData::solid-heat-conductivity}{solid\_heat\_conductivity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Heat conductivity of solid (rock).}
\KeyItem{\hyperB{HeatTransfer-BulkData::heat-dispersivity}{heat\_dispersivity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Default Field value: 0 \\ Heat dispersivity}
\KeyItem{\hyperB{HeatTransfer-BulkData::fracture-sigma}{fracture\_sigma}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Default Field value: 1 \\ Coefficient of diffusive transfer through fractures (for each substance).}
\KeyItem{\hyperB{HeatTransfer-BulkData::dg-penalty}{dg\_penalty}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Default Field value: 1.0 \\ Penalty parameter influencing the discontinuity of the solution (for each substance). Its default value 1 is sufficient in most cases. Higher value diminishes the inter-element jumps.}
\end{RecordType}
