...
\KeyItem{cross\_section}{Output of the field cross\_section (Complement dimension parameter (cross section for 1D, thickness for 2D).).}
\KeyItem{conductivity}{Output of the field conductivity (Isotropic conductivity scalar.).}
\KeyItem{sigma}{Output of the field sigma (Transition coefficient between dimensions.).}
\KeyItem{water\_source\_density}{Output of the field water\_source\_density (Water source density.).}
\KeyItem{init\_pressure}{Output of the field init\_pressure (Initial condition as pressure).}
\KeyItem{storativity}{Output of the field storativity (Storativity.).}
\KeyItem{pressure\_p0}{Output of the field pressure\_p0.}
\KeyItem{pressure\_p1}{Output of the field pressure\_p1.}
\KeyItem{piezo\_head\_p0}{Output of the field piezo\_head\_p0.}
\KeyItem{velocity\_p0}{Output of the field velocity\_p0.}
\KeyItem{subdomain}{Output of the field subdomain.}
\KeyItem{pressure\_diff}{Output of the field pressure\_diff.}
\KeyItem{velocity\_diff}{Output of the field velocity\_diff.}
\KeyItem{div\_diff}{Output of the field div\_diff.}
\end{SelectionType}
...
\KeyItem{rock\_density}{Output of the field rock\_density (Rock matrix density.).}
\KeyItem{sorption\_type}{Output of the field sorption\_type (Considered adsorption is described by selected isotherm.).}
\KeyItem{isotherm\_mult}{Output of the field isotherm\_mult (Multiplication parameters (k, omega) in either Langmuir c\_s = omega * (alpha*c\_a)/(1- alpha*c\_a) or in linear c\_s = k * c\_a isothermal description.).}
...
\KeyItem{init\_conc\_solid}{Output of the field init\_conc\_solid (Initial solid concentration of substances. Vector, one value for every substance.).}
\KeyItem{conc\_solid}{Output of the field conc\_solid.}
\end{SelectionType}
...
\KeyItem{isotherm\_other}{Output of the field isotherm\_other (Second parameters (alpha, ...) defining isotherm  c\_s = omega * (alpha*c\_a)/(1- alpha*c\_a).).}
\KeyItem{init\_conc\_solid}{Output of the field init\_conc\_solid (Initial solid concentration of substances. Vector, one value for every substance.).}
\KeyItem{conc\_immobile\_solid}{Output of the field conc\_immobile\_solid.}
\end{SelectionType}
...
\KeyItem{diffusion\_rate\_immobile}{Output of the field diffusion\_rate\_immobile (Diffusion coefficient of non-equilibrium linear exchange between mobile and immobile zone.).}
\KeyItem{porosity\_immobile}{Output of the field porosity\_immobile (Porosity of the immobile zone.).}
\KeyItem{init\_conc\_immobile}{Output of the field init\_conc\_immobile (Initial concentration of substances in the immobile zone.).}
\KeyItem{conc\_immobile}{Output of the field conc\_immobile.}
\end{SelectionType}
...
\KeyItem{sources\_density}{Output of the field sources\_density (Density of concentration sources.).}
\KeyItem{sources\_sigma}{Output of the field sources\_sigma (Concentration flux.).}
\KeyItem{sources\_conc}{Output of the field sources\_conc (Concentration sources threshold.).}
\KeyItem{init\_conc}{Output of the field init\_conc (Initial concentrations.).}
\KeyItem{conc}{Output of the field conc.}
\end{SelectionType}
...
\KeyItem{sources\_conc}{Output of the field sources\_conc (Concentration sources threshold.).}
\KeyItem{init\_conc}{Output of the field init\_conc (Initial concentrations.).}
\KeyItem{disp\_l}{Output of the field disp\_l (Longitudal dispersivity (for each substance).).}
\KeyItem{disp\_t}{Output of the field disp\_t (Transversal dispersivity (for each substance).).}
\KeyItem{diff\_m}{Output of the field diff\_m (Molecular diffusivity (for each substance).).}
\KeyItem{conc}{Output of the field conc.}
...
\KeyItem{\hyperB{HeatTransfer-DG-Data::solid-heat-exchange-rate}{solid\_heat\_exchange\_rate}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Heat exchange rate of source in solid.}
\KeyItem{\hyperB{HeatTransfer-DG-Data::fluid-ref-temperature}{fluid\_ref\_temperature}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Reference temperature of source in fluid.}
...
\KeyItem{init\_temperature}{Output of the field init\_temperature (Initial temperature.).}
\KeyItem{porosity}{Output of the field porosity (Porosity.).}
\KeyItem{fluid\_density}{Output of the field fluid\_density (Density of fluid.).}
\KeyItem{fluid\_heat\_capacity}{Output of the field fluid\_heat\_capacity (Heat capacity of fluid.).}
\KeyItem{fluid\_heat\_conductivity}{Output of the field fluid\_heat\_conductivity (Heat conductivity of fluid.).}
\KeyItem{solid\_density}{Output of the field solid\_density (Density of solid (rock).).}
\KeyItem{solid\_heat\_capacity}{Output of the field solid\_heat\_capacity (Heat capacity of solid (rock).).}
\KeyItem{solid\_heat\_conductivity}{Output of the field solid\_heat\_conductivity (Heat conductivity of solid (rock).).}
\KeyItem{disp\_l}{Output of the field disp\_l (Longitudal heat dispersivity in fluid.).}
\KeyItem{disp\_t}{Output of the field disp\_t (Transversal heat dispersivity in fluid.).}
\KeyItem{fluid\_thermal\_source}{Output of the field fluid\_thermal\_source (Thermal source density in fluid.).}
\KeyItem{solid\_thermal\_source}{Output of the field solid\_thermal\_source (Thermal source density in solid.).}
\KeyItem{fluid\_heat\_exchange\_rate}{Output of the field fluid\_heat\_exchange\_rate (Heat exchange rate in fluid.).}
\KeyItem{solid\_heat\_exchange\_rate}{Output of the field solid\_heat\_exchange\_rate (Heat exchange rate of source in solid.).}
\KeyItem{fluid\_ref\_temperature}{Output of the field fluid\_ref\_temperature (Reference temperature of source in fluid.).}
\KeyItem{solid\_ref\_temperature}{Output of the field solid\_ref\_temperature (Reference temperature in solid.).}
\KeyItem{temperature}{Output of the field temperature.}
\KeyItem{fracture\_sigma}{Output of the field fracture\_sigma (Coefficient of diffusive transfer through fractures (for each substance).).}
\KeyItem{dg\_penalty}{Output of the field dg\_penalty (Penalty parameter influencing the discontinuity of the solution (for each substance). Its default value 1 is sufficient in most cases. Higher value diminishes the inter-element jumps.).}
\end{SelectionType}
