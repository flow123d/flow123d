...
\KeyItem{\hyperB{Steady-MH::mortar-sigma}{mortar\_sigma}}{Double [0, ]}{1.0}{\AddDoc{Steady\_MH::mortar\_sigma}}{Conductivity between dimensions.}
...
\begin{RecordType}{\HTRaised{IT::FieldInterpolatedP0}{FieldInterpolatedP0}}{\hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{}{\AddDoc{FieldInterpolatedP0}}{Field given by P0 data on another mesh. Currently defined only on boundary.}
...
\KeyItem{\hyperB{FieldInterpolatedP0::mesh}{mesh}}{input file name}{\textless\it obligatory\textgreater}{\AddDoc{FieldInterpolatedP0::mesh}}{File with the mesh from which we interpolate. (currently only GMSH supported)}
\KeyItem{\hyperB{FieldInterpolatedP0::raw-data}{raw\_data}}{input file name}{\textless\it obligatory\textgreater}{\AddDoc{FieldInterpolatedP0::raw\_data}}{File with raw output from flow calculation. Currently we can interpolate only pressure.}
\end{RecordType}
...
\begin{RecordType}{\HTRaised{IT::FieldInterpolatedP0}{FieldInterpolatedP0}}{\hyperlink{IT::Field:R3 - Real[3,3]}{Field:R3 -> Real[3,3]}}{}{\AddDoc{FieldInterpolatedP0}}{Field given by P0 data on another mesh. Currently defined only on boundary.}
...
\KeyItem{\hyperB{Unsteady-MH::mortar-sigma}{mortar\_sigma}}{Double [0, ]}{1.0}{\AddDoc{Unsteady\_MH::mortar\_sigma}}{Conductivity between dimensions.}
...
\KeyItem{\hyperB{DarcyFlowMH-Steady-BoundaryData::bc-flux}{bc\_flux}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{DarcyFlowMH\_Steady\_BoundaryData::bc\_flux}}{Flux in Neumman or Robin boundary condition.}
\KeyItem{\hyperB{DarcyFlowMH-Steady-BoundaryData::bc-robin-sigma}{bc\_robin\_sigma}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{DarcyFlowMH\_Steady\_BoundaryData::bc\_robin\_sigma}}{Conductivity coefficient in Robin boundary condition.}
\KeyItem{\hyperB{DarcyFlowMH-Steady-BoundaryData::bc-piezo-head}{bc\_piezo\_head}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{DarcyFlowMH\_Steady\_BoundaryData::bc\_piezo\_head}}{Boundary condition for piezometric head.}
\KeyItem{\hyperB{DarcyFlowMH-Steady-BoundaryData::flow-old-bcd-file}{flow\_old\_bcd\_file}}{input file name}{\textless\it optional\textgreater}{\AddDoc{DarcyFlowMH\_Steady\_BoundaryData::flow\_old\_bcd\_file}}{}
\end{RecordType}
...
\KeyItem{\hyperB{DarcyFlowMH-Steady-BulkData::init-pressure}{init\_pressure}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{DarcyFlowMH\_Steady\_BulkData::init\_pressure}}{Initial condition as pressure}
\KeyItem{\hyperB{DarcyFlowMH-Steady-BulkData::storativity}{storativity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{DarcyFlowMH\_Steady\_BulkData::storativity}}{Storativity.}
\KeyItem{\hyperB{DarcyFlowMH-Steady-BulkData::init-piezo-head}{init\_piezo\_head}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{DarcyFlowMH\_Steady\_BulkData::init\_piezo\_head}}{Initial piezometric head.}
\end{RecordType}
...
\KeyItem{\hyperB{Unsteady-LMH::mortar-sigma}{mortar\_sigma}}{Double [0, ]}{1.0}{\AddDoc{Unsteady\_LMH::mortar\_sigma}}{Conductivity between dimensions.}
...
\begin{RecordType}{\HTRaised{IT::FieldInterpolatedP0}{FieldInterpolatedP0}}{\hyperlink{IT::Field:R3 - Real[n]}{Field:R3 -> Real[n]}}{}{\AddDoc{FieldInterpolatedP0}}{Field given by P0 data on another mesh. Currently defined only on boundary.}
...
\KeyItem{\hyperB{TransportDG-BulkData::sources-sigma}{sources\_sigma}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 -> Real[n]}}{\textless\it optional\textgreater}{\AddDoc{TransportDG\_BulkData::sources\_sigma}}{}
...
\KeyItem{\hyperB{TransportDG-BulkData::disp-l}{disp\_l}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{TransportDG\_BulkData::disp\_l}}{Longitudal dispersivity.}
\KeyItem{\hyperB{TransportDG-BulkData::disp-t}{disp\_t}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{TransportDG\_BulkData::disp\_t}}{Transversal dispersivity.}
\KeyItem{\hyperB{TransportDG-BulkData::diff-m}{diff\_m}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{TransportDG\_BulkData::diff\_m}}{Molecular diffusivity.}
\KeyItem{\hyperB{TransportDG-BulkData::sigma-c}{sigma\_c}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{TransportDG\_BulkData::sigma\_c}}{Coefficient of diffusive transfer through fractures.}
\KeyItem{\hyperB{TransportDG-BulkData::dg-penalty}{dg\_penalty}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{TransportDG\_BulkData::dg\_penalty}}{Penalty parameter influencing the discontinuity of the solution.}
\end{RecordType}
...
\KeyItem{\hyperB{Sorptions::substeps}{substeps}}{Integer }{10}{\AddDoc{Sorptions::substeps}}{Number of equidistant substeps, molar mass and isotherm intersections}
...
\KeyItem{\hyperB{Sorption-BulkData::immob-porosity}{immob\_porosity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{Sorption\_BulkData::immob\_porosity}}{Immobile porosity of the rock matrix.}
\end{RecordType}
...
\KeyItem{\hyperB{TransportOperatorSplitting-BulkData::sources-sigma}{sources\_sigma}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 -> Real[n]}}{\textless\it optional\textgreater}{\AddDoc{TransportOperatorSplitting\_BulkData::sources\_sigma}}{}
...
\KeyItem{\hyperB{TransportOperatorSplitting-BulkData::por-imm}{por\_imm}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{TransportOperatorSplitting\_BulkData::por\_imm}}{Immobile porosity}
\KeyItem{\hyperB{TransportOperatorSplitting-BulkData::alpha}{alpha}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 -> Real[n]}}{\textless\it optional\textgreater}{\AddDoc{TransportOperatorSplitting\_BulkData::alpha}}{Coefficients of non-equilibrium exchange.}
\KeyItem{\hyperB{TransportOperatorSplitting-BulkData::sorp-type}{sorp\_type}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 -> Real[n]}}{\textless\it optional\textgreater}{\AddDoc{TransportOperatorSplitting\_BulkData::sorp\_type}}{Type of sorption.}
\KeyItem{\hyperB{TransportOperatorSplitting-BulkData::sorp-coef0}{sorp\_coef0}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 -> Real[n]}}{\textless\it optional\textgreater}{\AddDoc{TransportOperatorSplitting\_BulkData::sorp\_coef0}}{Coefficient of sorption.}
\KeyItem{\hyperB{TransportOperatorSplitting-BulkData::sorp-coef1}{sorp\_coef1}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 -> Real[n]}}{\textless\it optional\textgreater}{\AddDoc{TransportOperatorSplitting\_BulkData::sorp\_coef1}}{Coefficient of sorption.}
\KeyItem{\hyperB{TransportOperatorSplitting-BulkData::phi}{phi}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 -> Real}}{\textless\it optional\textgreater}{\AddDoc{TransportOperatorSplitting\_BulkData::phi}}{Solid / solid mobile.}
\end{RecordType}
