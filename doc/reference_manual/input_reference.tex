...
\begin{AbstractType}
	...
	{{{Transport of soluted  substances.}% 
		...
		\Descendant{\TypeLink{IT::Solute-ConcDispersion-DG}{Solute{\_}ConcDispersion{\_}DG}}% 
\end{AbstractType}
\begin{RecordType}
...
Higher value diminishes the inter-element jumps.}% 
		...
		\SelectionItem
			{Solute-AdvectionDiffusion-DG-OutputFields::peclet-number}
			{peclet{\_}number}
			{{{}{$[-]$}{ Input field: Local Peclet number (ratio of advection to diffusion).}% 
}}
		\SelectionItem
		...
		\SelectionItem
			{Solute-AdvectionDiffusion-DG-OutputFields::element-measure}
			{element{\_}measure}
			{{{}{$[m^{-d}]$}{ Input field: Element measures.}% 
}}
		\SelectionItem
			{Solute-AdvectionDiffusion-DG-OutputFields::element-diameter}
			{element{\_}diameter}
			{{{}{$[m]$}{ Input field: Element diameters.}% 
}}
\end{SelectionType}
\begin{RecordType}
	{IT::Solute-ConcDispersion-DG}
	{Solute{\_}ConcDispersion{\_}DG}
	{\TypeLink{IT::Solute}{Solute}}% implements
	{}% reducible to key
	{{{Discontinuous Galerkin (DG) solver for solute transport.}% 
}}
		\RecKey
			{Solute-ConcDispersion-DG::user-fields}
			{user{\_}fields}
			{{array [0, UINT] of }{record: }\TypeLink{IT::Solute-ConcDispersion-DG-UserData}{Solute{\_}ConcDispersion{\_}DG:UserData}}{}
			{ \it{Optional}}
			{{{Input fields of the equation defined by user.}% 
}}
		\RecKey
			{Solute-ConcDispersion-DG::static-model}
			{static{\_}model}
			{{Bool}}{}
			{ \ValueDefault{false}}
		...
		\RecKey
			{Solute-ConcDispersion-DG::solvent-density}
			{solvent{\_}density}
			{{Double [0, +inf)}}{}
			{ \ValueDefault{1.0}}
			{{{Density of the solvent [ }{$kg.m^{-3}$}{ ].}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG::solver}
			{solver}
			{{record: }\TypeLink{IT::Petsc}{Petsc}}{}
			{ \ValueDefault{{\{}{\}}}}
			{{{Solver for the linear system.}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG::input-fields}
			{input{\_}fields}
			{{array [0, UINT] of }{record: }\TypeLink{IT::Solute-ConcDispersion-DG-Data}{Solute{\_}ConcDispersion{\_}DG:Data}}{}
			{ \it{Obligatory}}
			{{{Input fields of the equation.}% 
}}
		\RecKey
			{Solute-ConcDispersion-DG::dg-variant}
			{dg{\_}variant}
			{{selection: }\TypeLink{IT::DG-variant}{DG{\_}variant}}{}
			{ \ValueDefault{"non-symmetric"}}
			{{{Variant of the interior penalty discontinuous Galerkin method.}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG::dg-order}
			{dg{\_}order}
			{{Integer [0, 3]}}{}
			{ \ValueDefault{1}}
			{{{Polynomial order for the finite element in DG method (order 0 is suitable if there is no diffusion/dispersion).}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG::init-projection}
			{init{\_}projection}
			{{Bool}}{}
			{ \ValueDefault{true}}
			{{{If true, use DG projection of the initial condition field.
Otherwise, evaluate initial condition field directly (well suited for reading native data).}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG::output}
			{output}
			{{gen. record: }\TypeLink{IT::EquationOutput}{EquationOutput}}{{output{\_}field{\_}selection}{ = }\TypeLink{IT::Solute-ConcDispersion-DG-OutputFields}{Solute{\_}ConcDispersion{\_}DG:OutputFields}}
			{ \ValueDefault{{\{}"fields": ["conc"]{\}}}}
			{{{Specification of output fields and output times.}% 
}}
\end{RecordType}
\begin{RecordType}
	{IT::Solute-ConcDispersion-DG-UserData}
	{Solute{\_}ConcDispersion{\_}DG:UserData}
	{}% implements
	{}% reducible to key
	{{{Record to set fields of the equation: Solute{\_}ConcDispersion{\_}DG.}% 
}}
		\RecKey
			{Solute-ConcDispersion-DG-UserData::name}
			{name}
			{{String}}{}
			{ \it{Obligatory}}
			{{{Name of user defined field.}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-UserData::is-boundary}
			{is{\_}boundary}
			{{Bool}}{}
			{ \ValueDefault{false}}
			{{{Type of field: boundary or bulk.}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-UserData::scalar-field}
			{scalar{\_}field}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Instance of FieldAlgoBase ScalarField descendant.}\\{
...
If you set more than one of these keys, only first key is accepted.}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-UserData::vector-field}
			{vector{\_}field}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R-3-}{Field{\_}R3{\_}to{\_}R[3]}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Instance of FieldAlgoBase VectorField descendant.
See above for details.}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-UserData::tensor-field}
			{tensor{\_}field}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R-3-3-}{Field{\_}R3{\_}to{\_}R[3,3]}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Instance of FieldAlgoBase TensorField descendant.
See above for details.}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-UserData::unit}
			{unit}
			{{record: }\TypeLink{IT::Unit}{Unit}}{}
			{ \it{Optional}}
			{{{Unit of the field values provided in the main input file, in the external file, or by a function (FieldPython).}% 
...
\end{RecordType}
\begin{RecordType}
	{IT::Solute-ConcDispersion-DG-Data}
	{Solute{\_}ConcDispersion{\_}DG:Data}
	{}% implements
	{}% reducible to key
	{{{Record to set fields of the equation.}\\{
The fields are set only on the domain specified by one of the keys: 'region', 'rid'}\\{
and after the time given by the key 'time'. The field setting can be overridden by}\\{
 any Solute{\_}ConcDispersion{\_}DG:Data record that comes later in the boundary data array.}% 
}}
		\RecKey
			{Solute-ConcDispersion-DG-Data::region}
			{region}
			{{array [1, UINT] of }{String}}{}
			{ \it{Optional}}
			{{{Labels of the regions where to set fields. }% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::rid}
			{rid}
			{{Integer [0, INT]}}{}
			{ \it{Optional}}
			{{{ID of the region where to set fields.}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::time}
			{time}
			{{tuple: }\TypeLink{IT::TimeValue}{TimeValue}}{}
			{ \ValueDefault{0.0}}
			{{{Apply field setting in this record after this time.}\\{
These times have to form an increasing sequence.}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::porosity}
			{porosity}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Porosity of the mobile phase. }{$[-]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::sources-density}
			{sources{\_}density}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Density of concentration sources. }{$[m^{-3}kgs^{-1}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::sources-sigma}
			{sources{\_}sigma}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Concentration flux. }{$[s^{-1}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::sources-conc}
			{sources{\_}conc}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Concentration sources threshold. }{$[m^{-3}kg]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::bc-type}
			{bc{\_}type}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Solute-AdvectionDiffusion-BC-Type}{Solute{\_}AdvectionDiffusion{\_}BC{\_}Type}}
			{ \it{Optional}}
			{{{Type of boundary condition. }{$[-]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::bc-conc}
			{bc{\_}conc}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Dirichlet boundary condition (for each substance). }{$[m^{-3}kg]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::bc-flux}
			{bc{\_}flux}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Flux in Neumann boundary condition. }{$[m^{1-d}kgs^{-1}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::bc-robin-sigma}
			{bc{\_}robin{\_}sigma}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Conductivity coefficient in Robin boundary condition. }{$[m^{4-d}s^{-1}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::init-conc}
			{init{\_}conc}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Initial values for concentration of substances. }{$[m^{-3}kg]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::dispersion-uxx}
			{dispersion{\_}uxx}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R-3-3-}{Field{\_}R3{\_}to{\_}R[3,3]}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Dispersion 4-th order tensor component ux D ux.
Common for all substances right now. }{$[m]$}% 
}}
		\RecKey
			{Solute-ConcDispersion-DG-Data::dispersion-uyy}
			{dispersion{\_}uyy}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R-3-3-}{Field{\_}R3{\_}to{\_}R[3,3]}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Dispersion 4-th order tensor component uy D uy.
Common for all substances right now. }{$[m]$}% 
}}
		\RecKey
			{Solute-ConcDispersion-DG-Data::dispersion-uzz}
			{dispersion{\_}uzz}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R-3-3-}{Field{\_}R3{\_}to{\_}R[3,3]}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Dispersion 4-th order tensor component uz D uz.
Common for all substances right now. }{$[m]$}% 
}}
		\RecKey
			{Solute-ConcDispersion-DG-Data::dispersion-uyz}
			{dispersion{\_}uyz}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R-3-3-}{Field{\_}R3{\_}to{\_}R[3,3]}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Dispersion 4-th order tensor component uy D uz.
Common for all substances right now. }{$[m]$}% 
}}
		\RecKey
			{Solute-ConcDispersion-DG-Data::dispersion-uxz}
			{dispersion{\_}uxz}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R-3-3-}{Field{\_}R3{\_}to{\_}R[3,3]}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Dispersion 4-th order tensor component ux D uz.
Common for all substances right now. }{$[m]$}% 
}}
		\RecKey
			{Solute-ConcDispersion-DG-Data::dispersion-uxy}
			{dispersion{\_}uxy}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R-3-3-}{Field{\_}R3{\_}to{\_}R[3,3]}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Dispersion 4-th order tensor component ux D uy.
Common for all substances right now. }{$[m]$}% 
}}
		\RecKey
			{Solute-ConcDispersion-DG-Data::rock-density}
			{rock{\_}density}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Rock matrix density. }{$[m^{-3}kg]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::sorption-coefficient}
			{sorption{\_}coefficient}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Coefficient of linear sorption. }{$[m^{3}kg^{-1}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::v-norm}
			{v{\_}norm}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Velocity norm field. }{$[ms^{-1}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::mass-matrix-coef}
			{mass{\_}matrix{\_}coef}
			{{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Matrix coefficients computed by model in mass assemblation. }{$[m^{3-d}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::retardation-coef}
			{retardation{\_}coef}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Retardation coefficients computed by model in mass assemblation. }{$[m^{3-d}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::sources-density-out}
			{sources{\_}density{\_}out}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Concentration sources output - density of substance source, only positive part is used.. }{$[m^{-d}kgs^{-1}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::sources-sigma-out}
			{sources{\_}sigma{\_}out}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Concentration sources - Robin type, in{\_}flux = sources{\_}sigma * (sources{\_}conc - mobile{\_}conc). }{$[m^{3-d}s^{-1}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::sources-conc-out}
			{sources{\_}conc{\_}out}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Concentration sources output. }{$[m^{-3}kg]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::advection-coef}
			{advection{\_}coef}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R-3-}{Field{\_}R3{\_}to{\_}R[3]}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Advection coefficients model. }{$[ms^{-1}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::diffusion-coef}
			{diffusion{\_}coef}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R-3-3-}{Field{\_}R3{\_}to{\_}R[3,3]}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Diffusion coefficients model. }{$[m^{2}s^{-1}]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::fracture-sigma}
			{fracture{\_}sigma}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Coefficient of diffusive transfer through fractures (for each substance). }{$[-]$}% 
		...
		\RecKey
			{Solute-ConcDispersion-DG-Data::dg-penalty}
			{dg{\_}penalty}
			{{array [1, UINT] of }{gen. abstract: }\TypeLink{IT::Field-R3-to-R}{Field{\_}R3{\_}to{\_}R}}{{element{\_}input{\_}type}{ = }\TypeLink{IT::Double}{Double}}
			{ \it{Optional}}
			{{{Penalty parameter influencing the discontinuity of the solution (for each substance). Its default value 1 is sufficient in most cases.
...
\end{RecordType}
\begin{SelectionType}
	{IT::Solute-ConcDispersion-DG-OutputFields}
	{Solute{\_}ConcDispersion{\_}DG:OutputFields}
	{{{Selection of output fields for the Solute{\_}ConcDispersion{\_}DG model.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::porosity}
			{porosity}
			{{{}{$[-]$}{ Input field: Porosity of the mobile phase.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::water-content}
			{water{\_}content}
			{{{}{$[-]$}{ Input field: INTERNAL. Water content passed from unsaturated Darcy flow model.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::sources-density}
			{sources{\_}density}
			{{{}{$[m^{-3}kgs^{-1}]$}{ Input field: Density of concentration sources.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::sources-sigma}
			{sources{\_}sigma}
			{{{}{$[s^{-1}]$}{ Input field: Concentration flux.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::sources-conc}
			{sources{\_}conc}
			{{{}{$[m^{-3}kg]$}{ Input field: Concentration sources threshold.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::init-conc}
			{init{\_}conc}
			{{{}{$[m^{-3}kg]$}{ Input field: Initial values for concentration of substances.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::dispersion-uxx}
			{dispersion{\_}uxx}
			{{{}{$[m]$}{ Input field: Dispersion 4-th order tensor component ux D ux.
Common for all substances right now.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::dispersion-uyy}
			{dispersion{\_}uyy}
			{{{}{$[m]$}{ Input field: Dispersion 4-th order tensor component uy D uy.
Common for all substances right now.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::dispersion-uzz}
			{dispersion{\_}uzz}
			{{{}{$[m]$}{ Input field: Dispersion 4-th order tensor component uz D uz.
Common for all substances right now.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::dispersion-uyz}
			{dispersion{\_}uyz}
			{{{}{$[m]$}{ Input field: Dispersion 4-th order tensor component uy D uz.
Common for all substances right now.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::dispersion-uxz}
			{dispersion{\_}uxz}
			{{{}{$[m]$}{ Input field: Dispersion 4-th order tensor component ux D uz.
Common for all substances right now.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::dispersion-uxy}
			{dispersion{\_}uxy}
			{{{}{$[m]$}{ Input field: Dispersion 4-th order tensor component ux D uy.
Common for all substances right now.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::rock-density}
			{rock{\_}density}
			{{{}{$[m^{-3}kg]$}{ Input field: Rock matrix density.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::sorption-coefficient}
			{sorption{\_}coefficient}
			{{{}{$[m^{3}kg^{-1}]$}{ Input field: Coefficient of linear sorption.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::conc}
			{conc}
			{{{}{$[m^{-3}kg]$}{ Concentration solution.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::v-norm}
			{v{\_}norm}
			{{{}{$[ms^{-1}]$}{ Input field: Velocity norm field.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::mass-matrix-coef}
			{mass{\_}matrix{\_}coef}
			{{{}{$[m^{3-d}]$}{ Input field: Matrix coefficients computed by model in mass assemblation.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::retardation-coef}
			{retardation{\_}coef}
			{{{}{$[m^{3-d}]$}{ Input field: Retardation coefficients computed by model in mass assemblation.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::sources-density-out}
			{sources{\_}density{\_}out}
			{{{}{$[m^{-d}kgs^{-1}]$}{ Input field: Concentration sources output - density of substance source, only positive part is used..}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::sources-sigma-out}
			{sources{\_}sigma{\_}out}
			{{{}{$[m^{3-d}s^{-1}]$}{ Input field: Concentration sources - Robin type, in{\_}flux = sources{\_}sigma * (sources{\_}conc - mobile{\_}conc).}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::sources-conc-out}
			{sources{\_}conc{\_}out}
			{{{}{$[m^{-3}kg]$}{ Input field: Concentration sources output.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::advection-coef}
			{advection{\_}coef}
			{{{}{$[ms^{-1}]$}{ Input field: Advection coefficients model.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::diffusion-coef}
			{diffusion{\_}coef}
			{{{}{$[m^{2}s^{-1}]$}{ Input field: Diffusion coefficients model.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::fracture-sigma}
			{fracture{\_}sigma}
			{{{}{$[-]$}{ Input field: Coefficient of diffusive transfer through fractures (for each substance).}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::dg-penalty}
			{dg{\_}penalty}
			{{{}{$[-]$}{ Input field: Penalty parameter influencing the discontinuity of the solution (for each substance). Its default value 1 is sufficient in most cases.
Higher value diminishes the inter-element jumps.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::peclet-number}
			{peclet{\_}number}
			{{{}{$[-]$}{ Input field: Local Peclet number (ratio of advection to diffusion).}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::region-id}
			{region{\_}id}
			{{{}{$[-]$}{ Input field: Region ids.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::subdomain}
			{subdomain}
			{{{}{$[-]$}{ Input field: Subdomain ids of the domain decomposition.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::element-measure}
			{element{\_}measure}
			{{{}{$[m^{-d}]$}{ Input field: Element measures.}% 
}}
		\SelectionItem
			{Solute-ConcDispersion-DG-OutputFields::element-diameter}
			{element{\_}diameter}
			{{{}{$[m]$}{ Input field: Element diameters.}% 
}}
\end{SelectionType}
...
\begin{RecordType}
	...
	{FirstOrderReaction}
	{\TypeLink{IT::GenericReaction}{GenericReaction}{, }\TypeLink{IT::ReactionTermImmobile}{ReactionTermImmobile}{, }\TypeLink{IT::ReactionTermMobile}{ReactionTermMobile}{, }\TypeLink{IT::ReactionTerm}{ReactionTerm}}% implements
	{}% reducible to key
...
Higher value diminishes the inter-element jumps.}% 
		...
		\SelectionItem
			{Heat-AdvectionDiffusion-DG-OutputFields::peclet-number}
			{peclet{\_}number}
			{{{}{$[-]$}{ Input field: Local Peclet number (ratio of advection to diffusion).}% 
}}
		\SelectionItem
		...
		\SelectionItem
			{Heat-AdvectionDiffusion-DG-OutputFields::element-measure}
			{element{\_}measure}
			{{{}{$[m^{-d}]$}{ Input field: Element measures.}% 
}}
		\SelectionItem
			{Heat-AdvectionDiffusion-DG-OutputFields::element-diameter}
			{element{\_}diameter}
			{{{}{$[m]$}{ Input field: Element diameters.}% 
}}
\end{SelectionType}
