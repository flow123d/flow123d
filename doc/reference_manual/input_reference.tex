...
\KeyItem{region\_ids}{Output of the field region\_ids $[-]$.}
...
\KeyItem{\hyperB{DarcyFlowMH-Data::cross-section}{cross\_section}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Complement dimension parameter (cross section for 1D, thickness for 2D). $[m^{3-d}]$}
\KeyItem{\hyperB{DarcyFlowMH-Data::conductivity}{conductivity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Isotropic conductivity scalar. $[ms^{-1}]$}
...
\KeyItem{\hyperB{DarcyFlowMH-Data::water-source-density}{water\_source\_density}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Water source density. $[s^{-1}]$}
...
\KeyItem{\hyperB{DarcyFlowMH-Data::bc-pressure}{bc\_pressure}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Dirichlet BC condition value for pressure. $[m]$}
\KeyItem{\hyperB{DarcyFlowMH-Data::bc-flux}{bc\_flux}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Flux in Neumman or Robin boundary condition. $[m^{4-d}s^{-1}]$}
\KeyItem{\hyperB{DarcyFlowMH-Data::bc-robin-sigma}{bc\_robin\_sigma}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Conductivity coefficient in Robin boundary condition. $[m^{3-d}s^{-1}]$}
\KeyItem{\hyperB{DarcyFlowMH-Data::init-pressure}{init\_pressure}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Initial condition as pressure $[m]$}
\KeyItem{\hyperB{DarcyFlowMH-Data::storativity}{storativity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Storativity. $[m^{-1}]$}
...
\KeyItem{\hyperB{TransportOperatorSplitting::substances}{substances}}{Array  of record: \hyperlink{IT::Substance}{Substance}}{\textless\it obligatory\textgreater}{}{Specification of transported substances.}
...
\begin{RecordType}{\HTRaised{IT::Substance}{Substance}}{}{\hyperlink{Substance::name}{name}}{}{Chemical substance.}
...
\Descendant{\hyperlink{IT::FirstOrderReaction}{FirstOrderReaction}}
\Descendant{\hyperlink{IT::RadioactiveDecay}{RadioactiveDecay}}
...
\Descendant{\hyperlink{IT::Semchem}{Semchem}}
\end{AbstractType}

\begin{RecordType}{\HTRaised{IT::FirstOrderReaction}{FirstOrderReaction}}{\hyperlink{IT::ReactionTerm}{ReactionTerm}}{}{}{A model of first order chemical reactions (decompositions of a reactant into products).}
...
\KeyItem{\hyperB{FirstOrderReaction::reactions}{reactions}}{Array  of record: \hyperlink{IT::Reaction}{Reaction}}{\textless\it obligatory\textgreater}{}{An array of first order chemical reactions.}
\KeyItem{\hyperB{FirstOrderReaction::ode-solver}{ode\_solver}}{abstract type: \hyperlink{IT::LinearODESolver}{LinearODESolver}}{\textless\it optional\textgreater}{}{Numerical solver for the system of first order ordinary differential equations coming from the model.}
\end{RecordType}

\begin{RecordType}{\HTRaised{IT::Reaction}{Reaction}}{}{}{}{Describes a single first order chemical reaction.}
\KeyItem{\hyperB{Reaction::reactants}{reactants}}{Array [1, ] of record: \hyperlink{IT::FirstOrderReactionReactant}{FirstOrderReactionReactant}}{\textless\it obligatory\textgreater}{}{An array of reactants. Do not use array, reactions with only one reactant (decays) are implemented at the moment!}
...
\KeyItem{\hyperB{Reaction::products}{products}}{Array [1, ] of record: \hyperlink{IT::FirstOrderReactionProduct}{FirstOrderReactionProduct}}{\textless\it obligatory\textgreater}{}{An array of products.}
\end{RecordType}

\begin{RecordType}{\HTRaised{IT::FirstOrderReactionReactant}{FirstOrderReactionReactant}}{}{\hyperlink{FirstOrderReactionReactant::name}{name}}{}{A record describing a reactant of a reaction.}
...
\begin{RecordType}{\HTRaised{IT::FirstOrderReactionProduct}{FirstOrderReactionProduct}}{}{\hyperlink{FirstOrderReactionProduct::name}{name}}{}{A record describing a product of a reaction.}
...
\begin{AbstractType}{\HTRaised{IT::LinearODESolver}{LinearODESolver}}{}{}{Solver of a linear system of ODEs.}
\Descendant{\hyperlink{IT::PadeApproximant}{PadeApproximant}}
\Descendant{\hyperlink{IT::LinearODEAnalytic}{LinearODEAnalytic}}
\end{AbstractType}

\begin{RecordType}{\HTRaised{IT::PadeApproximant}{PadeApproximant}}{\hyperlink{IT::LinearODESolver}{LinearODESolver}}{}{}{Record with an information about pade approximant parameters.}
...
\begin{RecordType}{\HTRaised{IT::LinearODEAnalytic}{LinearODEAnalytic}}{\hyperlink{IT::LinearODESolver}{LinearODESolver}}{}{}{Evaluate analytic solution of the system of ODEs.}
...
\begin{RecordType}{\HTRaised{IT::RadioactiveDecay}{RadioactiveDecay}}{\hyperlink{IT::ReactionTerm}{ReactionTerm}}{}{}{A model of a radioactive decay and possibly of a decay chain.}
\KeyItem{\hyperB{RadioactiveDecay::TYPE}{TYPE}}{selection: ReactionTerm\_TYPE\_selection}{RadioactiveDecay}{}{Sub-record selection.}
\KeyItem{\hyperB{RadioactiveDecay::decays}{decays}}{Array [1, ] of record: \hyperlink{IT::Decay}{Decay}}{\textless\it obligatory\textgreater}{}{An array of radioactive decays.}
\KeyItem{\hyperB{RadioactiveDecay::ode-solver}{ode\_solver}}{abstract type: \hyperlink{IT::LinearODESolver}{LinearODESolver}}{\textless\it optional\textgreater}{}{Numerical solver for the system of first order ordinary differential equations coming from the model.}
\end{RecordType}

\begin{RecordType}{\HTRaised{IT::Decay}{Decay}}{}{}{}{A model of a radioactive decay.}
...
\KeyItem{\hyperB{Decay::products}{products}}{Array [1, ] of record: \hyperlink{IT::RadioactiveDecayProduct}{RadioactiveDecayProduct}}{\textless\it obligatory\textgreater}{}{An array of the decay products (daughters).}
\end{RecordType}

\begin{RecordType}{\HTRaised{IT::RadioactiveDecayProduct}{RadioactiveDecayProduct}}{}{\hyperlink{RadioactiveDecayProduct::name}{name}}{}{A record describing a product of a radioactive decay.}
...
\begin{RecordType}{\HTRaised{IT::Sorption}{Sorption}}{\hyperlink{IT::ReactionTerm}{ReactionTerm}}{}{}{Adsorption model in the reaction term of transport.}
...
\KeyItem{\hyperB{Sorption::reaction-liquid}{reaction\_liquid}}{abstract type: \hyperlink{IT::ReactionTerm}{ReactionTerm}}{\textless\it optional\textgreater}{}{Reaction model following the sorption in the liquid.}
\KeyItem{\hyperB{Sorption::reaction-solid}{reaction\_solid}}{abstract type: \hyperlink{IT::ReactionTerm}{ReactionTerm}}{\textless\it optional\textgreater}{}{Reaction model following the sorption in the solid.}
...
\KeyItem{\hyperB{Sorption-Data::rock-density}{rock\_density}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Rock matrix density. $[m^{-3}kg]$}
\KeyItem{\hyperB{Sorption-Data::sorption-type}{sorption\_type}}{abstract type: \hyperlink{IT::Field:R3 - Enum[n]}{Field:R3 $\rightarrow$ Enum[n]}}{\textless\it optional\textgreater}{}{Considered adsorption is described by selected isotherm. If porosity on an element is equal or even higher than 1.0 (meaning no sorbing surface), then type 'none' will be selected automatically. $[-]$}
\KeyItem{\hyperB{Sorption-Data::isotherm-mult}{isotherm\_mult}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Multiplication parameters (k, omega) in either Langmuir c\_s = omega * (alpha*c\_a)/(1- alpha*c\_a) or in linear c\_s = k * c\_a isothermal description. $[kg^{-1}mol]$}
...
\KeyItem{\hyperB{Sorption-Data::init-conc-solid}{init\_conc\_solid}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Initial solid concentration of substances. Vector, one value for every substance. $[kg^{-1}mol]$}
\end{RecordType}
...
\begin{RecordType}{\HTRaised{IT::SorptionMobile}{SorptionMobile}}{\hyperlink{IT::ReactionTerm}{ReactionTerm}}{}{}{Adsorption model in the mobile zone, following the dual porosity model.}
...
\KeyItem{\hyperB{SorptionMobile::reaction-liquid}{reaction\_liquid}}{abstract type: \hyperlink{IT::ReactionTerm}{ReactionTerm}}{\textless\it optional\textgreater}{}{Reaction model following the sorption in the liquid.}
\KeyItem{\hyperB{SorptionMobile::reaction-solid}{reaction\_solid}}{abstract type: \hyperlink{IT::ReactionTerm}{ReactionTerm}}{\textless\it optional\textgreater}{}{Reaction model following the sorption in the solid.}
...
\begin{RecordType}{\HTRaised{IT::SorptionImmobile}{SorptionImmobile}}{\hyperlink{IT::ReactionTerm}{ReactionTerm}}{}{}{Adsorption model in the immobile zone, following the dual porosity model.}
...
\KeyItem{\hyperB{SorptionImmobile::reaction-liquid}{reaction\_liquid}}{abstract type: \hyperlink{IT::ReactionTerm}{ReactionTerm}}{\textless\it optional\textgreater}{}{Reaction model following the sorption in the liquid.}
\KeyItem{\hyperB{SorptionImmobile::reaction-solid}{reaction\_solid}}{abstract type: \hyperlink{IT::ReactionTerm}{ReactionTerm}}{\textless\it optional\textgreater}{}{Reaction model following the sorption in the solid.}
...
\KeyItem{\hyperB{DualPorosity-Data::diffusion-rate-immobile}{diffusion\_rate\_immobile}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Diffusion coefficient of non-equilibrium linear exchange between mobile and immobile zone. $[s^{-1}]$}
...
\KeyItem{\hyperB{DualPorosity-Data::init-conc-immobile}{init\_conc\_immobile}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Initial concentration of substances in the immobile zone. $[m^{-3}kg]$}
\end{RecordType}
...
\begin{RecordType}{\HTRaised{IT::Semchem}{Semchem}}{\hyperlink{IT::ReactionTerm}{ReactionTerm}}{}{}{Declares infos valid for all reactions. NOT SUPPORTED!!!.}
...
\KeyItem{\hyperB{TransportOperatorSplitting-Data::sources-density}{sources\_density}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Density of concentration sources. $[m^{-3}kg]$}
\KeyItem{\hyperB{TransportOperatorSplitting-Data::sources-sigma}{sources\_sigma}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Concentration flux. $[s^{-1}]$}
\KeyItem{\hyperB{TransportOperatorSplitting-Data::sources-conc}{sources\_conc}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Concentration sources threshold. $[m^{-3}kg]$}
\KeyItem{\hyperB{TransportOperatorSplitting-Data::bc-conc}{bc\_conc}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Boundary conditions for concentrations. $[m^{-3}kg]$}
\KeyItem{\hyperB{TransportOperatorSplitting-Data::init-conc}{init\_conc}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Initial concentrations. $[m^{-3}kg]$}
...
\KeyItem{sources\_density}{Output of the field sources\_density $[m^{-3}kg]$ (Density of concentration sources.).}
...
\KeyItem{\hyperB{SoluteTransport-DG-Data::sources-density}{sources\_density}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Density of concentration sources. $[m^{-3}kg]$}
\KeyItem{\hyperB{SoluteTransport-DG-Data::sources-sigma}{sources\_sigma}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Concentration flux. $[s^{-1}]$}
\KeyItem{\hyperB{SoluteTransport-DG-Data::sources-conc}{sources\_conc}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Concentration sources threshold. $[m^{-3}kg]$}
\KeyItem{\hyperB{SoluteTransport-DG-Data::bc-conc}{bc\_conc}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Dirichlet boundary condition (for each substance). $[m^{-3}kg]$}
\KeyItem{\hyperB{SoluteTransport-DG-Data::init-conc}{init\_conc}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Initial concentrations. $[m^{-3}kg]$}
\KeyItem{\hyperB{SoluteTransport-DG-Data::disp-l}{disp\_l}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Longitudal dispersivity (for each substance). $[m]$}
\KeyItem{\hyperB{SoluteTransport-DG-Data::disp-t}{disp\_t}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Transversal dispersivity (for each substance). $[m]$}
\KeyItem{\hyperB{SoluteTransport-DG-Data::diff-m}{diff\_m}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Molecular diffusivity (for each substance). $[m^{2}s^{-1}]$}
...
\KeyItem{\hyperB{SoluteTransport-DG-Data::bc-flux}{bc\_flux}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Flux in Neumann boundary condition. $[m^{1-d}kgs^{-1}]$}
\KeyItem{\hyperB{SoluteTransport-DG-Data::bc-robin-sigma}{bc\_robin\_sigma}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Conductivity coefficient in Robin boundary condition. $[m^{4-d}s^{-1}]$}
\end{RecordType}
...
\KeyItem{\hyperB{HeatTransfer-DG-Data::bc-temperature}{bc\_temperature}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Boundary value of temperature. $[K]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::init-temperature}{init\_temperature}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Initial temperature. $[K]$}
...
\KeyItem{\hyperB{HeatTransfer-DG-Data::fluid-density}{fluid\_density}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Density of fluid. $[m^{-3}kg]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::fluid-heat-capacity}{fluid\_heat\_capacity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Heat capacity of fluid. $[m^{2}s^{-2}K^{-1}]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::fluid-heat-conductivity}{fluid\_heat\_conductivity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Heat conductivity of fluid. $[mkgs^{-3}K^{-1}]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::solid-density}{solid\_density}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Density of solid (rock). $[m^{-3}kg]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::solid-heat-capacity}{solid\_heat\_capacity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Heat capacity of solid (rock). $[m^{2}s^{-2}K^{-1}]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::solid-heat-conductivity}{solid\_heat\_conductivity}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Heat conductivity of solid (rock). $[mkgs^{-3}K^{-1}]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::disp-l}{disp\_l}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Longitudal heat dispersivity in fluid. $[m]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::disp-t}{disp\_t}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Transversal heat dispersivity in fluid. $[m]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::fluid-thermal-source}{fluid\_thermal\_source}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Thermal source density in fluid. $[m^{-1}kgs^{-3}]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::solid-thermal-source}{solid\_thermal\_source}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Thermal source density in solid. $[m^{-1}kgs^{-3}]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::fluid-heat-exchange-rate}{fluid\_heat\_exchange\_rate}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Heat exchange rate in fluid. $[s^{-1}]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::solid-heat-exchange-rate}{solid\_heat\_exchange\_rate}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Heat exchange rate of source in solid. $[s^{-1}]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::fluid-ref-temperature}{fluid\_ref\_temperature}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Reference temperature of source in fluid. $[K]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::solid-ref-temperature}{solid\_ref\_temperature}}{abstract type: \hyperlink{IT::Field:R3 - Real}{Field:R3 $\rightarrow$ Real}}{\textless\it optional\textgreater}{}{Reference temperature in solid. $[K]$}
...
\KeyItem{\hyperB{HeatTransfer-DG-Data::bc-flux}{bc\_flux}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Flux in Neumann boundary condition. $[m^{1-d}kgs^{-1}]$}
\KeyItem{\hyperB{HeatTransfer-DG-Data::bc-robin-sigma}{bc\_robin\_sigma}}{abstract type: \hyperlink{IT::Field:R3 - Real[n]}{Field:R3 $\rightarrow$ Real[n]}}{\textless\it optional\textgreater}{}{Conductivity coefficient in Robin boundary condition. $[m^{4-d}s^{-1}]$}
\end{RecordType}
