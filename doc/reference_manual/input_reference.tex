...
\begin{RecordType}
	...
	{{{FEM for linear elasticity.}% 
		...
		\RecKey
			...
			{{Bool}}{}
			{ \ValueDefault{false}}
			{{{If true, displacement will be corrected at contact zones.}% 
}}
		\RecKey
...
\begin{RecordType}
	...
	{FirstOrderReaction}
	{\TypeLink{IT::GenericReaction}{GenericReaction}{, }\TypeLink{IT::ReactionTermMobile}{ReactionTermMobile}{, }\TypeLink{IT::ReactionTermImmobile}{ReactionTermImmobile}{, }\TypeLink{IT::ReactionTerm}{ReactionTerm}}% implements
	{}% reducible to key
