...
several \hyperA{IT::LinearODESolver}{solvers} which we shall brielfy describe in this section. For the moment, however, we only use the method of Pad\'e approximant.
Let us denote 
the ODE system
\[
