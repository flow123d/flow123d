...
\end{equation}
where \hyperA{DarcyFlowMH-Steady-BulkData::storativity}{$S_d$} \units{}{-1}{} is the storativity and $F_d$ \units{}{3-d}{-1} is a source term. In our setting the principal unknowns of the system 
...
\hyperA{DarcyFlowMH-Steady-BulkData::sigma}{$\sigma_{32}$} \units{}{}{} and
\hyperA{DarcyFlowMH-Steady-BulkData::sigma}{$\sigma_{21}$} \units{}{}{} are independent scaling parameters which represent the ratio of the crosswind and the tangential conductivity in the fracture.
