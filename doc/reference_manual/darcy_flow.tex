...
Version 3.0.0 introduce an experimental support of the non-conforming meshes of mixed dimension. In particular 1D-2D coupling is 
supported in the 2D domain and 2D-3D and 2D-2D coupling is supported for the 3D domain. Lower dimensional elements can not represent barrieres,
i.e. we consider that the pressure and velocity fields are continuous accross the lower dimensional fractures.
