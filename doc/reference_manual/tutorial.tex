...
All the keys in record \Alink{IT::Balance}{\tt balance} are left with default values.
...
Let us suppose we would like to use a~sorption coefficient for uranium $K_d=1.6\cdot10^{-4}$ \unitss{-1}{3}{} (www.skb.se, report R-10-48 by James Crawford, 2010).
At first, we need to convert it to dimensionless value of \Alink{Sorption-Data::distribution-coefficient}{\tt distribution\_coefficient}
