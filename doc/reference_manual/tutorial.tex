...
and those defining the boundary conditions. We set only the conductivity field since other \hyperA{IT::Flow-Darcy-MH-Data}{\tt input\_fields}
...
See Section \ref{section_output} for the list of available \Alink{IT::Flow-Darcy-MH-OutputFields}{output \tt fields}.
...
and we want to use. We need to convert it to dimensionless value of \Alink{Sorption-Data::distribution-coefficient}{\tt distribution\_coefficient}
