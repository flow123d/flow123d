\section{Heat transport}\label{heat-transport}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.00000\textwidth]{images/07_bcmesh.pdf}
...
\subsubsection{Heat transport model}\label{heat-transport-model}
...
\begin{figure}[htbp]
\centering
\includegraphics{images/07_power.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.80000\textwidth]{images/07_flow.pdf}
\caption{The flux field with piezometric head.\label{fig:flux}}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.80000\textwidth]{images/07_transport.pdf}
