...
\hypertarget{fig:BCD}{%
\centering
\includegraphics[width=1\textwidth,height=\textheight]{tutor_figures/07_bcmesh.pdf}
...
\centering
\includegraphics[width=0.8\textwidth,height=\textheight]{tutor_figures/07_flow.pdf}
...
\centering
\includegraphics[width=0.8\textwidth,height=\textheight]{tutor_figures/07_transport.pdf}
