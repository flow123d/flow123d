...
with user-defined \hyperA{SoluteTransport-DG-Data::bc-flux}{concentration flux} $f^i_N$ \units{1}{-2}{-1},
\hyperA{SoluteTransport-DG-Data::bc-robin-sigma}{transition parameter} $\sigma^i_R$ \units{}{1}{-1},
\hyperA{SoluteTransport-DG-Data::bc-conc}{reference concentration} $c^i_R$ \units{1}{-3}{} and \hyperA{SoluteTransport-DG-Data::bc-ad-conc}{advected concentration} $c^i_A$ \units{1}{-3}{}.
\item \textbf{diffusive\_flux} Finally on $\Gamma_{DF}$ we prescribe diffusive mass flux through \hyperA{SoluteTransport-DG-Data::bc-flux}{concentration flux} $f^i_N$, \hyperA{SoluteTransport-DG-Data::bc-robin-sigma}{transition parameter} $\sigma^i_R$ and \hyperA{SoluteTransport-DG-Data::bc-conc}{reference concentration} $c^i_R$:
