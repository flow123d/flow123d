...
For $l$-th edge ($g_l$) we can define total edge flow $U_{g_{l}}$ eg. as
  \begin{eqnarray}
   U_{g_{l}} &=& \sum\limits_{m \in \mathcal{G}_{ji}}  \left[ U_{mj}^{+} + | U_{jm}^{-}| \right] = \sum\limits_{m \in \mathcal{G}_{jk}}  \left[ U_{mj}^{+} + | U_{jm}^{-}| \right] \notag \\
	      &=& \sum\limits_{m \in \mathcal{G}_{ij}}  \left[ U_{mi}^{+} + | U_{im}^{-}| \right] = \sum\limits_{m \in \mathcal{G}_{ik}}  \left[ U_{mi}^{+} + | U_{im}^{-}| \right] \notag \\ 
	      &=& \sum\limits_{m \in \mathcal{G}_{ki}}  \left[ U_{mk}^{+} + | U_{km}^{-}| \right] = \sum\limits_{m \in \mathcal{G}_{kj}}  \left[ U_{mk}^{+} + | U_{km}^{-}| \right]. \label{edgeflow} 
  \end{eqnarray}
