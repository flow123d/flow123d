...
\begin{itemize}
 \item In solid, $c_s = \frac{m_{sorbed}}{m_s}$ \units{}{}{} is the fraction of the mass $m_{sorbed}$ of the adsorbed solute 
       ...
       in solid can be selected for \Alink{IT::Sorption-output-fields}{output}.
...
\item \hyperA{Sorption-Data::distribution-coefficient}{Distribution coefficients} $k_i, i\in\{ l,F,L\}$ \units{-1}{3}{}.
...
\item \hyperA{Sorption-Data::isotherm-other}{Additional parameter} $\alpha$ \units{}{}{} can be set.
\end{itemize}
