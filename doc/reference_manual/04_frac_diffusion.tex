\section{Fractures and diffusion}\label{fractures-and-diffusion}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.00000\textwidth]{images/04_geomesh.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{images/04_mass_flux.pdf}
