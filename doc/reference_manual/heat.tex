...
\begin{itemize}
\item \hyperA{HeatTransfer-Data::fluid-density}{$\varrho_f$}, \hyperA{HeatTransfer-Data::solid-density}{$\varrho_s$} \units{1}{-3}{} is the density of the fluid and solid phase, respectively.
\item \hyperA{HeatTransfer-Data::fluid-heat-capacity}{$c_f$}, \hyperA{HeatTransfer-Data::solid-heat-capacity}{$c_s$} [J$\mathrm{kg}^{-1}\mathrm{K}^{-1}$] is the heat capacity of fluid and solid phase, respectively.
