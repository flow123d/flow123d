\section{1D column transport}\label{d-column-transport}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=1.00000\textwidth]{images/02_transport.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{images/02_mass_plot.pdf}
