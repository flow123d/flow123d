...
The simulation of equilibrial adsorption is based on solution of the couple of equations representing mass balance law and empirical description of adsorption represented by comon types of isotherm. Considered types of isotherm folows:
\begin{itemize}
 ...
 \item Langmuirs' isotherm $c_s = f(c_a) = k_L\cdot \frac{\alpha\cdot c_a}{1 + \alpha\cdot c_a}$, $sorption\_type$ is $"langmuir"$.
\end{itemize}
Notification:
\begin{itemize}
