...
Its form is determined by the parameter \hyperA{Adsorption-Data::sorption-type}{\tt sorption\_type}:
\begin{itemize}
...
\begin{itemize}
 ...
 \item \hyperA{Adsorption::solvent-density}{$\varrho_l$}, \hyperA{Adsorption-Data::rock-density}{$\varrho_s$} is the liquid (solvent) density and the solid (rock) density, respectively;
 \item \hyperA{Adsorption::molar-mass}{$M_s$} denotes the molar mass of a substance;
 \item Multiplication parameters $k_i, i\in\{ l,F,L\}$ [mol\,$\mathrm{kg}^{-1}$] are given by 
       \hyperA{Adsorption-Data::isotherm-mult}{\tt isotherm\_mult};
 \item Additional parameter $[\alpha] = 1$ is given by \hyperA{Adsorption-Data::isotherm-other}{\tt isotherm\_other}.
\end{itemize}
