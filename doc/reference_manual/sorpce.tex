...
$\hyperlink{TransportOperatorSplitting-Data::porosity::B}{\vartheta_m} = \vartheta$ the mobile porosity from 
transport equation \eqref{e:ADE}. One can also set non-zero initial concentration \hyperA{DualPorosity-Data::init-conc-immobile}{$c_i(0)$} 
...
\begin{itemize}
 ...
 \item \hyperA{Substance::molar-mass}{$M_s$} denotes the molar mass of a substance.
...
Non-zero initial concentration in the solid phase \hyperA{Sorption-Data::init-conc-solid}{$c_s(0)$} can be set in the input record. Now, further denoting
