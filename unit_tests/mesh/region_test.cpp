...
TEST(Region, read_sets_from_input) {
	...
	Input::JSONToStorage json_reader( read_sets_json, region_set_array_input_type, Input::FileFormat::format_JSON);
...
TEST(Region, read_element_map_from_input) {
	...
	Input::JSONToStorage json_reader( read_element_map_json, element_map_array_input_type, Input::FileFormat::format_JSON);
	Input::Array i_arr = json_reader.get_root_interface<Input::Array>();
