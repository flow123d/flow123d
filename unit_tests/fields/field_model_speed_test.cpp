...
public:
    ...
    /// Constructor.
    AssemblyDimTest(EqFields *eq_fields, EqData *eq_data, std::shared_ptr<EvalPoints> eval_points)
    : AssemblyBase<dim>(eq_data->order, eval_points), eq_fields_(eq_fields), eq_data_(eq_data) {
