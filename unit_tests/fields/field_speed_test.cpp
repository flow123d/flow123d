...
[   
    {
        ...
        elementwise_scalar={ TYPE="FieldElementwise", mesh_file="fields/simplest_cube_data.msh", field_name="scalar" },
        elementwise_vector_fixed={ TYPE="FieldElementwise", mesh_file="fields/simplest_cube_data.msh", field_name="vector_fixed" }
    },
    {
        region="set_2",
