...
//temp surface for 2d_fracture_2
Line Loop(62) = {13, -11, -3, 6, 20, -16};
Plane Surface(63) = {62};

trans = 0.21;
// duplicate temp surface parallel down
p0[] = Translate {-trans, -trans, 0} {
  Duplicata { Surface{63}; }
};

// duplicate temp surface parallel up
p1[] = Translate {trans, trans, 0} {
  Duplicata { Surface{63}; }
};

// triangle fracture
Point(100) = {1.5, 1.4, 0, mesh_t};
Point(101) = {-0.5, 0.3, -0.1, mesh_t};
Point(102) = {-0.1, -0.8, 2.3, mesh_t};
Line(110) = {101, 100};
Line(111) = {100, 102};
Line(112) = {102, 101};
Line Loop(120) = {111, 112, 110};
...
Physical Surface("2d_fracture_S1") = {p0[0]};
Physical Surface("2d_fracture_S2") = {p1[0]};
Physical Surface("triangle_1") = {121};
Physical Surface("triangle_2") = {p2[0]};
...
Save "cube_mult_compXincomp_triangle.msh";
Exit
