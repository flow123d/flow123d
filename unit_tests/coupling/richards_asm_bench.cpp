...
#include "richards_mockup.impl.hh"
#include "bench_meshes_handler.hh"


TEST_F(RichardsMockupTest, simple_asm) {
    ...
    std::vector<std::string> meshes_table = mesh_handler.get_mesh_names("richards_asm");
    ...
    this->profiler_output("richards_asm");
