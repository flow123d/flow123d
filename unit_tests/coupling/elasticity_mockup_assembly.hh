...
public:
    ...
    : StiffnessAssemblyElasticity<dim, TEqData>(eq_data, asm_internals) {}
...
public:
    ...
    /// Constructor.
    RhsEvalFields(EqData *eq_data, AssemblyInternals *asm_internals)
    : RhsAssemblyElasticity<dim, TEqData>(eq_data, asm_internals) {}
