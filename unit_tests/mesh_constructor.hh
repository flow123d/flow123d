 ...
 * Construct reader.
 */
std::shared_ptr<BaseMeshReader> reader_constructor(const std::string &input_str="{mesh_file=\"\"}",
    ...
    return BaseMeshReader::reader_factory(reader.get_root_interface<Input::Record>());
}
