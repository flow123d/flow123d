...
.PHONY: doc-doxy
doc-doxy: cmake
	make -C $(BUILD_DIR)/doc doc-doxy

# Create user manual; use makefile generated by cmake
.PHONY: doc-pdf
doc-pdf: cmake inputref
	make -C $(BUILD_DIR)/doc/reference_manual doc-pdf
...
.PHONY: inputref
inputref: $(DOC_DIR)/input_reference.tex
