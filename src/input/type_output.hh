...
protected:
     ...
     */
    virtual void print_impl(ostream& stream, const AdHocAbstract *type, unsigned int depth) = 0;
    /**
...
protected:
    ...
    void print_impl(ostream& stream, const AdHocAbstract *type, unsigned int depth);
