...
class SecondaryEquation : public EquationBase, public EquationForMassBalance {

public:

	SecondaryEquation(Mesh &mesh, const Input::Record in_rec) : EquationBase(mesh, in_rec) {};
 ...
 * transport equations.
 */
class TransportBase : public SecondaryEquation {
public:
