...
ConcentrationTransportModel::ModelEqData::ModelEqData() : TransportBase::TransportEqData("ConcentrationTransport")
{
...
void ConcentrationTransportModel::set_eq_data(DarcyFlowMH::EqData &water_data)
{
	data().cross_section = &water_data.cross_section;
}
...
void HeatTransferModel::set_eq_data(DarcyFlowMH::EqData &water_data)
{
	data().cross_section = &water_data.cross_section;
}
