...
public:
    ...
    /// Constructor.
    MassAssemblyConvection(EqFields *eq_fields, EqData *eq_data, PatchFEValues<3> *fe_values)
...
public:
    ...
    /// Constructor.
    InitCondAssemblyConvection(EqFields *eq_fields, EqData *eq_data, PatchFEValues<3> *fe_values)
    : AssemblyBase<dim>(0, fe_values), eq_fields_(eq_fields), eq_data_(eq_data) {
        this->active_integrals_ = ActiveIntegrals::bulk;
...
public:
    ...
    /// Constructor.
    ConcSourcesBdrAssemblyConvection(EqFields *eq_fields, EqData *eq_data, PatchFEValues<3> *fe_values)
    : AssemblyBase<dim>(0, fe_values), eq_fields_(eq_fields), eq_data_(eq_data) {
...
public:
    ...
    /// Constructor.
    MatrixMpiAssemblyConvection(EqFields *eq_fields, EqData *eq_data, PatchFEValues<3> *fe_values)
    : AssemblyBase<dim>(0, fe_values), eq_fields_(eq_fields), eq_data_(eq_data) {
