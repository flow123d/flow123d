...
public:
    MHFEValues();
    ~MHFEValues();
    void update(ElementFullIter ele, FieldType &cond_anisothropy);
    double * local_matrix();
...
private:
    void local_matrix_line(ElementFullIter ele, FieldType &cond_anisothropy);
    void local_matrix_triangle(ElementFullIter ele, FieldType &cond_anisothropy);
    void local_matrix_tetrahedron(ElementFullIter ele, FieldType &cond_anisothropy);
