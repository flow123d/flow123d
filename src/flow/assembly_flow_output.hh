...
public:
    ...
    /// Constructor.
    L2DifferenceAssembly(EqFields *eq_fields, EqData *eq_data, PatchFEValues<3> *fe_values)
    : AssemblyBase<dim>(2, fe_values), eq_fields_(eq_fields), eq_data_(eq_data) {
...
public:
    ...
    /// Constructor.
    OutputInternalFlowAssembly(EqFields *eq_fields, EqData *eq_data, PatchFEValues<3> *fe_values)
