...
//    {}
    ...
    inline FeQArray<Vector> grad_scalar_shape(uint component_idx=0)
    {
        ...
        return FeQArray<Vector>(patch_point_vals_, true, scalar_shape_grads_op_idx, fe_component->n_dofs());
    }
...
public:
    ...
    inline FeQArray<Scalar> scalar_shape(uint component_idx = 0)
    {
        ...
        return FeQArray<Scalar>(patch_point_vals_, false, scalar_shape_op_idx, fe_component->n_dofs());
    }
...
public:
    ...
    inline FeQJoin<Scalar> scalar_join_shape(uint component_idx = 0)
    {
        ...
        return FeQJoin<Scalar>(patch_point_vals_bulk_, patch_point_vals_side_, fe_component_low->n_dofs(),
