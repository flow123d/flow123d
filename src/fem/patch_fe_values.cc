...
JoinShapeAccessor<ValueType>::JoinShapeAccessor(PatchFEValues<3> *fe_values, unsigned int begin, unsigned int lower_dim, unsigned int join_idx)
: fe_values_(fe_values), begin_(begin), join_idx_(join_idx) {
