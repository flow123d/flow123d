...
: dim_eval_points_({DimEvalPoints(0), DimEvalPoints(1), DimEvalPoints(2), DimEvalPoints(3)}),
  bulk_integrals_tmp_({{ nullptr, nullptr, nullptr, nullptr }}), edge_integrals_tmp_({{ nullptr, nullptr, nullptr }}), max_size_(0)
{}
...
//
//    if (bulk_integrals_tmp_[dim] == nullptr) {
//        dim_eval_points_[dim].add_local_points<dim>( quad.get_points() );
//        uint i_subset = dim_eval_points_[dim].add_subset();
//        bulk_integrals_tmp_[dim] = std::make_shared<BulkIntegral>(shared_from_this(), dim, i_subset);
//        this->set_max_size();
//    }
//    return bulk_integrals_tmp_[dim];
//}
//
//template <>
...
//
//    if (bulk_integrals_tmp_[0] == nullptr) {
//        uint i_subset = dim_eval_points_[0].add_subset();
//        bulk_integrals_tmp_[0] = std::make_shared<BulkIntegral>(shared_from_this(), 0, i_subset);
//        this->set_max_size();
//    }
//    return bulk_integrals_tmp_[0];
//}
//
//template <unsigned int dim>
...
//
//    if (edge_integrals_tmp_[dim-1] == nullptr) {
...
//        }
//        uint i_subset = dim_eval_points_[dim].add_subset();
//        edge_integrals_tmp_[dim-1] = std::make_shared<EdgeIntegral>(shared_from_this(), dim, i_subset);
//        this->set_max_size();
//    }
//    return edge_integrals_tmp_[dim-1];
//}
//
//template <unsigned int dim>
...
//        dim_eval_points_[dim].add_local_points<dim>( quad->get_points() );
//        uint i_subset = dim_eval_points_[dim].add_subset();
//        bulk_integrals_tmp_[dim] = std::make_shared<BulkIntegralAcc<dim>>(shared_from_this(), quad, pfev, element_cache_map, i_subset);
//        this->set_max_size();
//    }
//    return std::static_pointer_cast<BulkIntegralAcc<dim>>(bulk_integrals_tmp_[dim]);
//}
//
//template <>
...
//    if (bulk_integrals_tmp_[0] == nullptr) {
//        uint i_subset = dim_eval_points_[0].add_subset();
//        bulk_integrals_tmp_[0] = std::make_shared<BulkIntegralAcc<0>>(shared_from_this(), quad, pfev, element_cache_map, i_subset);
//        this->set_max_size();
//    }
//    return std::static_pointer_cast<BulkIntegralAcc<0>>(bulk_integrals_tmp_[0]);
//}
//
//template <unsigned int dim>
...
//        }
//        uint i_subset = dim_eval_points_[dim].add_subset();
//        edge_integrals_tmp_[dim-1] = std::make_shared<EdgeIntegralAcc<dim>>(shared_from_this(), quad, pfev, element_cache_map, i_subset);
//        this->set_max_size();
//    }
//    return std::static_pointer_cast<EdgeIntegralAcc<dim>>(edge_integrals_tmp_[dim-1]);
//}
//
//template <unsigned int dim>
