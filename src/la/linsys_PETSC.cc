...
LinSys::SolveInfo LinSys_PETSC::solve()
{
    ...
    if (rows_ds_->np() > 1) {
       ...
       if (this->is_positive_definite())
           petsc_dflt_opt="-ksp_type cg -ksp_diagonal_scale_fix -pc_type asm -pc_asm_overlap 4 -sub_pc_type lu";
           ...
           petsc_dflt_opt="-ksp_type bcgs -ksp_diagonal_scale_fix -pc_type asm -pc_asm_overlap 4 -sub_pc_type lu";
           //petsc_dflt_opt="-ksp_type bcgs -ksp_diagonal_scale_fix -pc_type asm -pc_asm_overlap 4 -sub_pc_type ilu -sub_pc_factor_levels 3 -sub_pc_factor_fill 6.0";
        ...
        // serial setting
       if (this->is_positive_definite())
           petsc_dflt_opt="-ksp_type preonly -pc_type lu";
