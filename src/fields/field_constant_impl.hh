...
template <int spacedim, class Value>
const Input::Registrar< FieldConstant<spacedim, Value> > FieldConstant<spacedim, Value>::registrar =
		Input::Registrar< FieldConstant<spacedim, Value> >("FieldConstant"); //+FieldBase<spacedim, Value>::template_name()
