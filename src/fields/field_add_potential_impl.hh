 ...
 */
template <int spacedim, class Value>
typename Value::return_type const & FieldAddPotential<spacedim, Value>::value(const Point<spacedim> &p, ElementAccessor<spacedim> &elm)
{
 ...
 */
template <int spacedim, class Value>
void FieldAddPotential<spacedim, Value>::value_list (const std::vector< Point<spacedim> >  &point_list, ElementAccessor<spacedim> &elm,
