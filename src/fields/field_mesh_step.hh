 ...
 *
 *
 * @file    field_mesh_step.hh
 * @brief
 */

#ifndef FIELD_MESH_STEP_HH_
...
/**
 * Specialized field represents mesh step ('h') of FieldFormula.
 */
class FieldMeshStep : public FieldCommon {
public:
    /// Constructor
    FieldMeshStep()
      : value_cache_( FieldValueCache<double>(1, 1) )
    {
    ...
    IT::Instance get_input_type() override {
        ASSERT_PERMANENT(false).error("This method can't be used for FieldMeshStep");
    ...
    void copy_from(FMT_UNUSED const FieldCommon & other) override {
        ASSERT_PERMANENT(false).error("Forbidden method for FieldMeshStep!");
    }
