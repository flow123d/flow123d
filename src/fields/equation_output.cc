...
void EquationOutput::initialize(std::shared_ptr<OutputTime> stream, Mesh *mesh, Input::Record in_rec, const TimeGovernor & tg)
{
    ...
    output_elem_data_assembly_ = new GenericAssembly< AssemblyOutputElemData >(this, this, true);
    output_node_data_assembly_ = new GenericAssembly< AssemblyOutputNodeData >(this, this, true);
    output_corner_data_assembly_ = new GenericAssembly< AssemblyOutputNodeData >(this, this, true);
