...
void VtkMeshReader::create_node_element_caches() {
	...
	this->get_element_data<double>(point_header.n_entities, point_header.n_components, false, 0, 0.0 );
    ...
    std::vector<unsigned int> &offsets_vec = *( this->get_element_data<unsigned int>(offset_header.n_entities, offset_header.n_components, false, 0, 0 ) );
    ...
    this->get_element_data<unsigned int>(con_header.n_entities, con_header.n_components, false, 0, 0 );
