...
public:
    ...
    /// Constructor.
    FlowPotentialAssemblyHM(EqFields *eq_fields, EqData *eq_data, std::shared_ptr<EvalPoints> eval_points)
    : AssemblyBase<dim>(1, eval_points), eq_fields_(eq_fields), eq_data_(eq_data) {
...
public:
    ...
    /// Constructor.
    ResidualAssemblyHM(EqFields *eq_fields, EqData *eq_data, std::shared_ptr<EvalPoints> eval_points)
    : AssemblyBase<dim>(1, eval_points), eq_fields_(eq_fields), eq_data_(eq_data) {
