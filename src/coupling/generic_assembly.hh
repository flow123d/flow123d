...
private:
            ...
            if (coupling_integral != nullptr) {
                ...
                if (add_bulk_points) {
                    ...
                    for( DHCellSide ngh_side : cell.neighb_sides() ) {
                        ...
                        ppv_low.elems_dam_data_vec_->n_elems_.insert(cell.elm_idx());
            	...
            	for( DHCellSide ngh_side : cell.neighb_sides() ) { // cell -> elm lower dim, ngh_side -> elm higher dim
                    ...
                    ppv_high.elems_dam_data_vec_->n_elems_.insert(ngh_side.elem_idx());
                    ++ppv_high.n_sides_;
    ...
    inline void add_volume_integral(const DHCellAccessor &cell) {
        ...
        ppv.elems_dam_data_vec_->n_elems_.insert(cell.elm_idx());;
    ...
    inline void add_edge_integral(const DHCellSide &cell_side) {
        ...
        for( DHCellSide edge_side : range ) {
            ...
            ppv.elems_dam_data_vec_->n_elems_.insert(edge_side.elem_idx());
            ++ppv.n_sides_;
    ...
    inline void add_boundary_integral(const DHCellSide &bdr_side) {
        ...
        ppv.elems_dam_data_vec_->n_elems_.insert(bdr_side.elem_idx());
        ++ppv.n_sides_;
