...
private:
    ...
    void patch_reinit() {
        ...
        patch_internals_.fe_values_.add_patch_points<3>(multidim_assembly_[3_d]->integrals(), &patch_internals_.element_cache_map_);
        patch_internals_.fe_values_.add_patch_points<2>(multidim_assembly_[2_d]->integrals(), &patch_internals_.element_cache_map_);
        patch_internals_.fe_values_.add_patch_points<1>(multidim_assembly_[1_d]->integrals(), &patch_internals_.element_cache_map_);
