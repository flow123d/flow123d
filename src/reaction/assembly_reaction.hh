...
public:
    ...
    /// Constructor.
    InitConditionAssemblyDp(EqFields *eq_fields, EqData *eq_data, std::shared_ptr<EvalPoints> eval_points)
...
public:
    ...
    /// Constructor.
    ReactionAssemblyDp(EqFields *eq_fields, EqData *eq_data, std::shared_ptr<EvalPoints> eval_points)
    : AssemblyBase<dim>(0, eval_points), eq_fields_(eq_fields), eq_data_(eq_data) {
        this->active_integrals_ = ActiveIntegrals::bulk;
...
public:
    ...
    /// Constructor.
    InitConditionAssemblySorp(EqFields *eq_fields, EqData *eq_data, std::shared_ptr<EvalPoints> eval_points)
    : AssemblyBase<dim>(0, eval_points), eq_fields_(eq_fields), eq_data_(eq_data) {
        this->active_integrals_ = ActiveIntegrals::bulk;
...
public:
    ...
    /// Constructor.
    ReactionAssemblySorp(EqFields *eq_fields, EqData *eq_data, std::shared_ptr<EvalPoints> eval_points)
    : AssemblyBase<dim>(0, eval_points), eq_fields_(eq_fields), eq_data_(eq_data) {
        this->active_integrals_ = ActiveIntegrals::bulk;
