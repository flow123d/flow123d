...
class Linear_reaction
{
	...
	private:
		...
		int *Set_indeces(char *section, int nr_of_substances); ///< reads a sequence of numbers defining an order of substances in decay chain, from ini-file
		...
		double *Set_half_lives(char *section, int nr_of_substances); ///< reads a sequence of halflives belonging to separate decay chain steps, from ini-file
