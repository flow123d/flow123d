...
#                     
#   - PYTHON_SYSPATH
#          - variable is not required in this script but must be set later on
#            so we can alter PYTHONPATH properly
...
if(NOT ${PYTHON_COPY})
    ...
    # variable PYTHON_EXTRA_MODULES_PATH
    set(PYTHON_EXTRA_MODULES_PATH ${CMAKE_SOURCE_DIR}/src/python)
else()
    ...
    set(PYTHON_EXTRA_MODULES_PATH ${PY_BUILD_PREFIX}/lib/flow123d)
