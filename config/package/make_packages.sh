...
${dexec} cp -r ${flow_repo_location}/build_tree/_CPack_Packages/Linux/TGZ/Flow123d-${release_version}-Linux ${flow_install_location}/build_package
# we only use temporary installation and copy it directly from the build image to the taget image
